...
//! \param:   TODO
//! ----------------------------------------------------------------------------
unsigned int sha256(unsigned char* ao_sha,
                    const void* a_bytes,
                    const size_t a_len)
{
        EVP_MD_CTX *ctx;
...
//! \param:   TODO
//! ----------------------------------------------------------------------------
int ec_encrypt(unsigned char* ao_ciphertext,
               int* ao_ciphertext_len,
               unsigned char* ao_tag,
               const unsigned char* a_plaintext,
...
//! \param:   TODO
//! ----------------------------------------------------------------------------
int ec_decrypt(unsigned char* ao_plaintext,
               int* a_plaintext_len,
...
//! ----------------------------------------------------------------------------
//! \details:  Returns the size a buffer needs to be to contain a valid token
...
//! ----------------------------------------------------------------------------
//! \details: Encrypt and internally validate a provided token
//! \return:  0 on success
